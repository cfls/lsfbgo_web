            ...
            @if ($currentQuestion)
                ...
                <div class="overflow-hidden relative">
                    <div
                            ...
                            wire:loading.class="opacity-0 scale-95"
                            wire:loading.class.remove="opacity-100 scale-100"
                            wire:target="nextStep"
                            class="opacity-100 scale-100 transition-all duration-300"
                    >
                        {{-- Video Display --}}
                        <x-video-display
                ...
                {{-- Feedback OUTSIDE overflow-hidden so fixed works correctly --}}
                @if (!$showPaymentModal)
