...
<div class="space-y-2 min-h-screen game-container">
    ...
    <div class="bg-white p-3 rounded-2xl shadow max-w-5xl w-full mx-auto relative"
        ...
        {{-- Anuncio de éxito para lector de pantalla --}}
        <span
                class="sr-only"
                aria-live="assertive"
                aria-atomic="true"
        ...
        {{-- ✅ OPCIÓN 3: guía en tiempo real cuando hay letra seleccionada --}}
        <p
                x-show="selectedLetter !== null && !completed"
                x-transition:enter="transition ease-out duration-200"
                x-transition:enter-start="opacity-0 -translate-y-1"
                x-transition:enter-end="opacity-100 translate-y-0"
                class="text-center text-sm text-blue-500 font-medium mb-2"
                aria-live="polite"
        >
            ✋ Touchez maintenant une case pour placer la lettre
        </p>
        ...
        @if ($currentWord)
            <div class="mb-2">
                ...
                {{-- ✅ OPCIÓN 2: instrucción inicial, solo en móvil, desaparece al interactuar --}}
                <p
                        x-show="!hasStarted"
                        x-transition:leave="transition ease-in duration-200"
                        x-transition:leave-start="opacity-100"
                        x-transition:leave-end="opacity-0"
                        class="text-center text-xs text-gray-400 italic mb-2 md:hidden"
                        aria-live="polite"
                >
                    👆 Appuyez sur une lettre, puis sur une case pour la placer
                </p>
